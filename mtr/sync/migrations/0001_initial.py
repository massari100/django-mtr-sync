    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_action', models.CharField(verbose_name='mtr.sync:data action', choices=[('create', 'mtr.sync:Create instances without filter')], max_length=255, blank=True)),
        ...
        migrations.AddField(
            model_name='report',
            name='settings',
            field=models.ForeignKey(verbose_name='mtr.sync:settings', related_name='reports', null=True, to='mtr_sync.Settings', blank=True),
        ),
        migrations.AddField(
            model_name='filter',
            name='settings',
            field=models.ForeignKey(verbose_name='mtr.sync:settings', related_name='filters', to='mtr_sync.Settings'),
        ),
        migrations.AddField(
            model_name='field',
            name='settings',

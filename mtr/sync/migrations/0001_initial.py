    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_action', models.CharField(choices=[('create', 'mtr.sync:Create instances without filter')], verbose_name='mtr.sync:data action', max_length=255, blank=True)),
        ...
        migrations.AddField(
            model_name='report',
            name='settings',
            field=models.ForeignKey(verbose_name='mtr.sync:settings', null=True, to='mtr_sync.Settings', blank=True, related_name='reports'),
        ),
        migrations.AddField(
            model_name='field',
            name='settings',

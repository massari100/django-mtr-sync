    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_value', models.TextField(blank=True, max_length=60000, verbose_name='mtr.sync:input value', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buffer_file', models.FileField(blank=True, db_index=True, upload_to=mtr.sync.settings.get_buffer_file_path, verbose_name='file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=20000, verbose_name='description', null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='report',
            name='settings',
            field=models.ForeignKey(related_name='reports', to='mtrsync.Settings', verbose_name='settings', blank=True, null=True),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_value', models.TextField(max_length=60000, null=True, verbose_name='mtr.sync:input value', blank=True)),
            ],
            options={
                'verbose_name': 'error',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_by', models.BooleanField(default=False, verbose_name='filter')),
            ],
            options={
                'ordering': ['position'],
                'verbose_name': 'field',

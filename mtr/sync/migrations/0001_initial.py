...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('position', models.PositiveIntegerField(verbose_name='utils:position', default=0, null=True, blank=True)),
                ...
                ('set_filter', models.CharField(max_length=255, verbose_name='mtr.sync:set filter type', blank=True, choices=[('not', 'mtr.sync:Not create or update instance if empty cell')])),
                ...
                ('converters', models.CharField(max_length=255, verbose_name='mtr.sync:converters', blank=True, choices=[('decimal', 'mtr.sync:Decimal'), ('string', 'mtr.sync:String'), ('comalist', 'mtr.sync:Coma separated list'), ('boolean', 'mtr.sync:Boolean'), ('filepath', 'mtr.sync:File path'), ('integer', 'mtr.sync:Integer'), ('none', 'mtr.sync:None')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buffer_file', models.FileField(verbose_name='mtr.sync:file', upload_to=mtr.sync.settings.get_buffer_file_path, blank=True, db_index=True, help_text='mtr.sync:File for import action')),
                ('dataset', models.CharField(max_length=255, verbose_name='mtr.sync:dataset', help_text='mtr.sync:Custom registered dataset if you import or export data from different source, for example network or ftp server', blank=True, choices=[('some_dataset', 'some description')])),
                ('data_action', models.CharField(max_length=255, verbose_name='mtr.sync:data action', help_text='mtr.sync:What will be done with data, for example, create or some custom opeartion eg. download image from server', blank=True, choices=[('create', 'mtr.sync:Create only'), ('create_or_update', 'mtr.sync:Create or update'), ('update', 'mtr.sync:Update only')])),
                ...
                ('language', models.CharField(max_length=255, verbose_name='mtr.sync:language', help_text='mtr.sync:Activates language before action, for example if you want you have modeltranslation app and you need to export or import only for choosed language', blank=True, choices=[('de', 'German'), ('en', 'English')])),
